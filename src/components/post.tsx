      ...
      <CardContent className="p-0">
        ...
        {post.media.length > 0 && (
          <div className="relative aspect-square w-full">
            <Image src={post.media[0] || "/placeholder.svg"} alt="Post image" fill className="object-cover" />
          </div>
        )}
      </CardContent>
      <CardFooter className="flex flex-col p-0">
        <div className="flex items-center justify-between px-4 py-2">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" onClick={handleLike} disabled={!session}>
          ...
          <Button variant="ghost" size="icon" onClick={() => setBookmarked(!bookmarked)} disabled={!session}>
            ...
            <div className="mb-4 space-y-3">
              <div className="flex items-start gap-2">
                <Avatar className="h-7 w-7">
                  <AvatarImage src="/placeholder.svg?height=28&width=28" alt="Comment user" />
                  <AvatarFallback>JD</AvatarFallback>
                </Avatar>
                <div className="flex-1">
                  <div className="rounded-xl bg-muted p-2 text-sm">
                    <span className="font-medium">johndoe</span> Amazing shot! The lighting is perfect.
                  </div>
